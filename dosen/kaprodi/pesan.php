...
<html lang="id">
<head>
    <meta charset="utf-8"><title>Pesan | Kaprodi</title>
            ...
            <div class="content-box">
                    ...
                    <div class="col-md-5">
                        <div class="msg-info-box">
                            ...
                            <div class="d-flex align-items-center border-top pt-2">
                                ...
                                <a href="?folder=sent" class="folder-link <?= $folder=='sent'?'active':'' ?>">Riwayat Validasi</a>
                ...
                <div class="table-msg-header mb-3">
                    <table class="table table-hover table-sm mb-0 small">
                        <thead><tr><th width="20%">Waktu</th><th>Pesan</th><th width="15%" class="text-center">Status</th></tr></thead>
                        <tbody>
