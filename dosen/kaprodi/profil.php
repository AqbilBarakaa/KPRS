    ...
    <div class="row">
        <div class="col-md-9">
            <div class="content-box">
                <div class="msg-header"><i class="fas fa-user-tie me-2"></i> Profil Kaprodi</div>
                <div class="row">
                    <div class="col-md-3 text-center mb-4">
                        <div class="card p-2 shadow-sm">
                            <img src="<?= $fotoUrl ?>" class="img-fluid" style="width: 150px; height: 180px; object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-md-9">
                        <table class="table table-striped table-hover">
                            <tbody>
                                ...
                                <tr><th>Jabatan</th><td><span class="badge bg-primary">KAPRODI</span></td></tr>
                            </tbody>
                        </table>
                        <div class="alert alert-info py-2 small"><i class="fas fa-info-circle"></i> Data dikelola oleh Bagian Tata Usaha.</div>
                    </div>
                </div>
            </div>
        </div>
